...
if(.Platform$OS.type=='Windows') { 
  mydir = "C:\\Users\\kayle\\Documents\\Quercus_IUCN_samp_sims\\Allele_lim_check\\original_sims" #If Windows, use this file path
...
final_quercus_results = array(0, dim = c(500,100,1))

final_alleles_all_quercus = array(0, dim=c(500,100,1))

alleles_capt_all_quercus = array(0, dim=c(500,100,1))
...
setwd("C:\\Users\\kayle\\Documents\\Quercus_IUCN_samp_sims\\Allele_lim_check\\original_sims")
