...
if(.Platform$OS.type=='Windows') { 
  mydir = "C:\\Users\\kayle\\Documents\\Quercus_IUCN_samp_sims\\Allele_lim_check\\Alternative\\Simulations" #If Windows, use this file path
} else if(.Platform$OS.type=='Unix') {
  mydir = "C:/Users/kayle/Documents/Quercus_IUCN_samp_sims/Allele_lim_checl/Alternative\Simulations" #If Linux, use this file path
}
setwd(mydir)
